    ...
    render() {
        return (
            <div>
                ...
                on-campus employees during the COVID-19 pandemic. The study’s Principal Investigators are Prof.
                ...
                <p className='lead'>Executive Summary</p>
                <ul>
                    <li>
                        You are being invited to participate in this study because you have been approved for on-campus
                        work at UC Berkeley between June 2020 and January 2021.
                    </li>
                    <li>
                        The specific purpose of this study is to model and evaluate the efficacy of asymptomatic testing and
                        automated contact tracing to prevent the spread of COVID-19 within the campus population.
                    </li>
                    <li>
                        For this study, you will give saliva samples at campus kiosks every other week which will be tested in
                        a COVID-19 diagnostics lab. These tests are not FDA approved so if they return a positive or
                        inconclusive result, you will be directed to confirmatory testing at University Health Services.
                    </li>
                    <li>
                        Your participation in this study is optional and will not affect your ability to return to work on
                        campus or receive symptomatic testing for COVID-19 by University Health Services.
                    </li>
                </ul>
                <p className='lead'>Procedures</p>
                <p>
                    If you agree to participate in this study, you will be given access to regular (bi-weekly) saliva-based
                    COVID-19 testing set up to test exclusively asymptomatic individuals. You will schedule visits to testing
                    kiosks spread throughout the UC Berkeley campus using an online scheduling application every two
                    weeks.
                </p>
                <p>
                    During the scheduling you will be asked several brief questions. At the testing kiosk you will need to
                    present your ID and confirmation email. At the kiosk, you will spit into a tube while being watched by
                    kiosk personnel. You will then return the tube to the personnel. This sample will be brought to the IGI
                    SARS-CoV-2 diagnostics lab for testing.
                </p>
                <p>
                    The procedure at the testing site will take 5-10 minutes each visit. In total, for the duration of this study,
                    you can expect to spend a total of roughly 2 hours for the asymptomatic testing. You can opt out of this
                    study at any time and will not be penalized for missing appointments.
                </p>
                <p>
                    If your sample tests positive for SARS-CoV-2, the virus that causes COVID-19, or is inconclusive, you will
                    be called and send an encrypted email by a clinician who will recommend that you to self-isolate and
                    guide you to make an appointment with the UHS Tang Center for confirmatory. This confirmatory
                    testing is important because the saliva-based test has not been fully approved by the FDA for diagnosis
                    of COVID-19. The confirmatory testing is not a part of this research study and only exists to inform
                    clinical decisions about your care.
                </p>
                ...
                <p className='lead'>Risks/Discomforts</p>
                <p>
                ...
                <p className='lead'>Confidentiality</p>
                <p>
                ...
                <p>
                    ...
                    system or at the time of enrollment are kept on an encrypted server that will not be distributed to
                    anyone other than the diagnostic testing lab; local, state, and federal public health agencies such as the
                    California Department of Public Health; the Food and Drug Administration (FDA) and other government
                    agencies involved in keeping research safe for people; and University of California staff who have
                    oversight over the diagnostic lab or the testing kiosks.
                </p>
                <p>
                    When the research is completed, your data and samples may be saved for future research. You have the
                    option to opt-out of this. Your data will be retained indefinitely by the diagnostics lab in a HIPAA-
                    compliant database for legal requirements of their licensure.
                </p>
                <p>
                    Clinically relevant results, including individual results, will be disclosed to you if the diagnostics lab finds
                    that your saliva sample is positive for SARS-CoV-2 or is inconclusive.
                </p>
                <p className='lead'>Financial Considerations</p>
                <p>
                    You will not be paid for participation in this study, nor will you or your insurance carriers be asked to pay
                    to participate in this study.
                </p>
                <p className='lead'>Rights</p>
                <p>
                    <u>Participation in research is completely voluntary.</u> You have the right to decline to participate or
                    withdraw at any point in this study without penalty or loss of benefits to which you are otherwise
                    entitled.
                </p>
                <p>
                    If you withdraw from the research, the data collected about you up to the point of withdrawal will
                    remain part of the study and may not be removed from the study database but will not be incorporated
                    into analyses of the data.
                </p>
                <p className='lead'>Questions</p>
                <p>
                    If you have any questions or concerns about this study, you may contact Alexander Ehrenberg at <a href='mailto:ehrenberg@berkeley.edu'>ehrenberg@berkeley.edu</a>
                </p>
                <p>
