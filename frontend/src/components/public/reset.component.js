...
import { externalResetPassword } from '../../actions/authActions';
              ...
              <Formik
                ...
                onSubmit={(values, { setSubmitting }) => {
                  ...
                  grecaptcha.ready(async () => {
                    try {
                      const token = await grecaptcha.execute(this.props.siteKey, {action: 'reset'});
                      const { success } = await externalResetPassword(values, uid, token);
